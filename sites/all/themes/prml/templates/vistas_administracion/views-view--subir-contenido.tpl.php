...
<div class="<?php print $classes; ?>">
  ...
  <?php
	$block = module_invoke('prml_administracion', 'block_view', 'BLOQUE_DE_ADMINISTRACION');
	print render($block['content']);
  ?>
  

<div class="add_content_admin_title col-md-12"><h4>Buscar</h4></div>
  
  <div class="administration_menu_prml col-md-12">
